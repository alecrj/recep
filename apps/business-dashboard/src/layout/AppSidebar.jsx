...
const AppSidebar = () => {
  ...
  return (
    <aside
      className={`fixed mt-16 flex flex-col lg:mt-0 top-0 px-5 left-0 bg-zinc-900 border-zinc-800 text-white h-screen transition-all duration-300 ease-in-out z-50 border-r
        ${
